public class Main {
    public static void main(String[] args) {
       ...
       String randomText = "random text";
        int randomNumber = randomText;

        int randomNumber2 = 2;
        String randomText2 = randomNumber2;

        char randomChar = "a";
        String randomText3 = randomChar;

        boolean randomBoolean = true;
        String randomText4 = randomBoolean;
        System.out.println(randomText4);  */
         ...
         //Zadatak 5.
            ...
            double decimalNumber = 42.001;
                    ...
                    //Zadatak 6.
                    int firstNumber = 82;
                    char firstLetter = (char) firstNumber;
                    int secondNumber = 73;
                    char secondLetter = (char) secondNumber;
                    int thirdNumber = 65;
                    char thirdLetter = (char) thirdNumber;
                    int fourthNumber = 68;
                    char fourthLetter = (char) fourthNumber;
